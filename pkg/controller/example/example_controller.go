...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &isuttonv1alpha1.Example{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileExample) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &isuttonv1alpha1.Example{}
	...
	// Set Example instance as the owner and controller
...
func newPodForCR(cr *isuttonv1alpha1.Example) *corev1.Pod {
